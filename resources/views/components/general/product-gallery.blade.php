...
>
    ...
    <div class="relative w-[calc(100%-170px)] lg:w-[calc(100%-150px)]">
        ...
        <button
            @click="pervSlide()"
            class="absolute left-0 top-1/2 z-10 me-4 -translate-y-1/2 rounded-full bg-white/80 p-2 shadow-lg transition-colors hover:bg-white disabled:opacity-50"
        ...
        <button
            @click="nextSlide()"
            class="absolute end-0 top-1/2 z-10 ms-4 -translate-y-1/2 rounded-full bg-white/80 p-2 shadow-lg transition-colors hover:bg-white disabled:opacity-50"
