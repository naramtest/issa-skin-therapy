...
return [
    ...
    "decimal" =>
        "يجب أن يحتوي الحقل :attribute على :decimal منزلة/منازل عشرية.",
    ...
    "max_digits" =>
        "يجب ألا يحتوي الحقل :attribute على أكثر من :max رقم/أرقام.",
    ...
    "password" => [
        ...
        "mixed" =>
            "يجب أن يحتوي حقل :attribute على حرف كبير وحرف صغير على الأقل.",
    ...
    "present_unless" =>
        "يجب أن يكون الحقل :attribute متوفراً ما لم يكن :other يساوي :value.",
    "present_with" => "يجب أن يكون الحقل :attribute متوفراً عند توفر :values.",
    "present_with_all" =>
        "يجب أن يكون الحقل :attribute متوفراً عند توفر :values.",
